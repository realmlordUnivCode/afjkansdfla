...
alert("welcome to universe code, aka idle catcher, story is being revised so please check back later for that, but please stay and play, Try to catch the yellow coins that give you 50 gold(To begin with)");
alert("The red coins take away thirty coins");
alert("We have a shop which will help you along your way to achieving 'Cosmic peace'");
alert("Id like to personally thank all of you beta testers, especially for those of you who have been on board since sixth grade, and if you are new, thank you as well.");
